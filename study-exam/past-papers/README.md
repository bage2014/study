...
> ★ 拓展手册：刷完每套真题，错题涉及的知识点查 [notes/11-papers-supplement.md](../notes/11-papers-supplement.md)（五年汇总 + 公式卡 + 案例套路 + 论文论据 + 混淆清单）。
...
| 试题 | 主题 | 5 年必考套路 | 真题索引 |
|------|------|--------------|----------|
| **试题一** | 质量属性 + 架构风格 | 给 8-12 条需求→识别质量属性→对比两种架构风格→补架构图 | [2024-#1](afternoon-case/2024-case.md) [2025-#1](afternoon-case/2025-case.md) [2023-#1](afternoon-case/2023-case.md) |
...
- **总字数**：约 12 万字
- **真实题目原文**：2024/2025 上午 + 2024/2025 案例 + 2021-2025 全部论文题目均为真题原文
