...
public class PipelineStatusUpdateActivityImpl implements PipelineStatusUpdateActivity {
    ...
    @Override
    public void recordStageStart(String runId, String stageName, int orderNum) {
        log.info("Recording stage start: {} - {}, order: {}", runId, stageName, orderNum);
        pipelineService.recordStageStart(runId, stageName, orderNum);
    }

    @Override
    public void recordStageEnd(String runId, String stageName, String resultJson, String errorMessage) {
        log.info("Recording stage end: {} - {}, error: {}", runId, stageName, errorMessage);
        pipelineService.recordStageEnd(runId, stageName, resultJson, errorMessage);
    }
}
