...
public class MyMyBatisGenerator {
    ...
    private void writeGeneratedJavaFile(GeneratedJavaFile gjf, ProgressCallback callback)
        ...
        try {
            ...
            addToList(targetFile, source, gjf.getFileEncoding());
    ...
    private void writeGeneratedXmlFile(GeneratedXmlFile gxf, ProgressCallback callback)
        ...
        try {
            ...
            callback.startTask(getString(
                    "Progress.15", targetFile.getName())); //$NON-NLS-1$
            addToList(targetFile, source, "UTF-8"); //$NON-NLS-1$
        } catch (ShellException e) {
            warnings.add(e.getMessage());
        }
    }
     ...
     *             Signals that an I/O exception has occurred.
     */
    private void addToList(File file, String content, String fileEncoding) throws IOException {
