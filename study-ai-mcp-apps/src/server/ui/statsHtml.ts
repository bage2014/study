    ...
    <body class="bg-gray-50 min-h-screen">
      ...
      <script>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="stat-card">
            <h3 class="text-base font-semibold mb-3">性别比例</h3>
            <div class="space-y-3">
              <div>
          ...
          <div class="stat-card">
            <h3 class="text-base font-semibold mb-3">在世状态</h3>
            <div class="space-y-3">
              <div>
                <div class="flex justify-between text-xs sm:text-sm mb-1">
                  <span>在世</span>
            ...
            <div class="stat-card">
              <h3 class="text-base font-semibold mb-3">年龄分布</h3>
                ...
                \${ageKeys.map(key => {
                  ...
                  return \`
                    <div class="text-center">
                      <div style="height: 80px; display: flex; flex-direction: column-reverse; margin-bottom: 4px;">
                        <div class="chart-bar" style="height: \${height}%; font-size: 10px; padding: 4px;">
                          \${count}
                        </div>
                      </div>
